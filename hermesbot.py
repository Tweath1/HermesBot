        ...
        if message.content.lower().startswith("$build"):
            ...
            if len(m) < 2:
                ...
                if actgod.lower() in (assassin.lower() for assassin in Assassins):
                    ...
                    color = "fc0303"
                embed = discord.Embed(title=f"{actgod} {role} Build".title(),
        ...
        if message.content.lower().startswith("$matchups"):
            ...
            if len(m) < 2:
                ...
                if actgod.lower() in (assassin.lower() for assassin in Assassins):
                    ...
                    color = "fc0303"
                embed = discord.Embed(title=actgod + " " + role + " Worst Matchups".title(),
                                      description="Games: {} | Wins: {} | WR: {} \n [See more info here](https://www.smitestats.gg/#/{})".format(
                                          data["games"], data["wins"], data["winRate"], actgod.replace(" ", "_")),
                                      color=int(color, base=16))
                embed.set_thumbnail(url=iconURL)
        ...
        if message.content.lower().startswith("$goodmatchups"):
            ...
            if len(m) < 2:
                ...
                if actgod.lower() in (assassin.lower() for assassin in Assassins):
                    ...
                    color = "fc0303"
                embed = discord.Embed(title=f"{actgod} {role} Best Matchups".title(),
                                      description="Games: {} | Wins: {} | WR: {} \n [See more info here](https://www.smitestats.gg/#/{})".format(
                                          data["games"], data["wins"], data["winRate"], actgod.replace(" ", "_")),
                                      color=int(color, base=16))
                embed.set_thumbnail(url=iconURL)
